...
public class APIDemo extends Controller
{
    ...
    public Result getDemoPojoTree()
    {
        ...
        {
            //The web service I am calling
            String myURL = "http://service.dice.com/api/rest/jobsearch/v1/simple.json?text=java&city=72227";
            //String myURL = "invalid url"; //just a string
            //Turn the string into a URL
            URL url = new URL(myURL);
    ...
    public Result getLatinDemo()
    {

        LatinDemo latindemo = null;
        // Connect to the URL using java's native library
        try
        {
            //The web service I am calling
            ...
            //Use a generic tree structure here
            ObjectMapper objectMapper = new ObjectMapper();
            latindemo = objectMapper.readerFor(LatinDemo.class).readValue(url);
        }
        catch (Exception e)
        {
            Logger.error("oh no! got some exception: " + e.getMessage());
        ...
        return ok(views.html.latindemo.render(latindemo));
    }
